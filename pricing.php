...
?>
    ...
    <div class="s-py-100">
        <div class="container">
            ...
            <div class="flex flex-wrap justify-center lg:grid sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-[30px] max-w-[1342px] mx-auto">
                
                <!-- pricings code  -->
                <?php
                    include "$base_dir/Components/Pages/pricings.php";
                ?>
    ...
    <!-- Partner Area Start -->
    <div class="bg-[#F5F5F5] dark:bg-primary dark:bg-opacity-10 py-12">
        <div class="container">
            <div class="flex flex-wrap items-center justify-evenly gap-y-8 gap-x-5">
                
                <!-- trusted-partner5 code  -->
                <?php
                    include "$base_dir/Components/Pages/trusted-partner5.php";
                ?>
