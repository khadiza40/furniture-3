    ...
    <div class="group">
        <div class="relative overflow-hidden">
            <a href="product-details.php?title=<?php echo urlencode(str_replace(' ', '-', strtolower($item['title']))); ?>">
                <img class="w-full transform group-hover:scale-110 duration-300 sm:max-h-[320px] object-cover" src="<?php echo $static_url, $item['img']; ?>" alt="product-card"> 
            </a>
...
<?php foreach ($products1 as $item): ?>
    ...
    <div class="group flex flex-col">
        <div class="relative overflow-hidden flex-1">
            <a href="product-details.php?title=<?php echo urlencode(str_replace(' ', '-', strtolower($item['title']))); ?>">
                <img class="w-full transform group-hover:scale-110 duration-300 h-full object-cover" src="<?php echo $static_url, $item['img']; ?>" alt="product-card">
            </a>
