...
<div class="group">
    ...
    <div class="mt-5 md:mt-7">
        ...
        <h5 class="mt-3 text-xl font-normal dark:text-white leading-[1.5]"><a href="product-details.php?title=<?php echo urlencode(str_replace(' ', '-', strtolower($item['title']))); ?>"><?php echo $item['title']; ?></a></h5>
    </div>
</div>
<?php endforeach; ?>