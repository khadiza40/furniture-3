...
<div class="relative overflow-hidden group">
    ...
    <?php if ($item['tag1'] === 'true'): ?>
        <button class="absolute z-10 top-3 left-3 btn-tag">
            -10%
        </button>
    <?php endif; ?>
        
    <div class="absolute z-10 top-1/2 lg:top-1/3 xl:top-1/2 left-1/2 transform -translate-y-2/4 -translate-x-2/4 flex gap-2">
    ...
    <div class="flex items-start justify-between gap-3 flex-wrap absolute z-20 w-11/12 bottom-3 xl:bottom-5 left-2/4 transform -translate-x-1/2 p-4 xl:p-5 bg-white dark:bg-title bg-opacity-[85%] dark:bg-opacity-[85%]">
        <div>
        ...
        <h4 class="font-semibold leading-none italic dark:text-white text-xl md:text-2xl"><?php echo $item['price']; ?></h4>
    </div>
</div>
<?php endforeach; ?>