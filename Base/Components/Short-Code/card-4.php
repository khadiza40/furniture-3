...
<div>
    <div class="relative overflow-hidden before:absolute card-gradient-overlay before:w-full before:h-full before:top-0 before:left-0 before:z-10 before:opacity-0 hover:before:opacity-100 before:duration-300 group">
        ...
        <div class="flex flex-col gap-[10px] absolute z-20 bottom-5 right-5">
            <a href="#" class="w-9 lg:w-12 h-9 p-2 lg:h-12 flex items-center justify-center transition-all duration-300 bg-white dark:bg-title bg-opacity-10 dark:bg-opacity-60 transform translate-y-8 opacity-0 group-hover:opacity-100 group-hover:translate-y-0">
            ...
            <button class="w-9 lg:w-12 h-9 p-2 lg:h-12 flex items-center justify-center transition-all duration-500 bg-white dark:bg-title bg-opacity-10 dark:bg-opacity-80 faveIcon transform translate-y-8 opacity-0 group-hover:opacity-100 group-hover:translate-y-0">
        ...
        <div class="absolute z-30 top-2/4 left-2/4 transform -translate-x-2/4 -translate-y-2/4 flex items-center justify-center bg-white dark:bg-title bg-opacity-20 dark:bg-opacity-70 rounded-full p-3 scale-0 group-hover:scale-100 duration-300">
            <div class="w-16 md:w-20 h-16 md:h-20 bg-white rounded-full dark:bg-title flex items-center justify-center">
                <h4 class="font-normal leading-none dark:text-white text-2xl"><?php echo $item['price']; ?></h4>
            </div>
        </div>
    </div>
    <h5 class="leading-none font-normal mt-4 md:mt-6 dark:text-white text-xl"><?php echo $item['title']; ?></h5>
</div>
<?php endforeach; ?>