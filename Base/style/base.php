...
<html lang="en">
    <head>
        ...
        <title>PHP Furniture & Home Decor eCommerce Template</title>
        ...
        <link href="<?php echo $static_url; ?>/css/output.css" rel="stylesheet">
    ...
    <script src="https://cdn.tailwindcss.com"></script>
        ...
        if (array_key_exists($fpage, $footerFiles)) {
            ...
            include 'footer.php'; // Default footer
        }
        ?>
        ...
        <script src="<?php echo $static_url; ?>/js/scripts.js"></script>
