<!-- Header Area Start -->
<div class="header-v3-area fixed left-0 right-0 tp-0 z-50 before:absolute before:h-full before:top-0 before:left-0 before:z-[-1] bg-white dark:bg-title before:w-[190px] sm:before:w-[250px] lg:before:w-[22%] xl:before:w-[19%]">
    <div class="container-fluid">
        <div class="header-v3-wrapper relative max-w-[1720px] mx-auto flex items-center justify-between py-3 sm:py-5 lg:py-0">
            <a href="index.php" class="header-v3-logo">
            ...
            <div class="flex items-center gap-12 2xl:gap-24">
                ...
                <div class="flex items-center gap-3 sm:gap-4 md:gap-6">
                    ...
                    <div class="hdr_profile_menu absolute z-50 top-full right-[50px] sm:right-[80px] min-w-[180px] sm:min-w-[220px] bg-white dark:bg-title py-[10px] sm:py-[20px] px-5 sm:px-[30px] border border-secondary opacity-0 invisible transition-all transform translate-y-5 mt-[3px] border-[#bb976d]">
