        ...
        <div class="max-w-[940px] mx-auto">
            <div data-aos="fade-up">
                <ul class="flex items-center gap-[10px] flex-wrap">
                    ...
                    <li><a href="blog-v1.php" class="inline-block text-title font-medium text-[15px] leading-none py-[10px] px-5 rounded-md bg-primary-midum">
                        <?php 
                ...
                <h1 class="text-2xl leading-snug sm:text-3xl sm:leading-snug md:text-[40px] mt-4 md:mt-6 md:leading-snug font-bold">
                    <?php 
                        if (!empty($article['title'])) {
                            ...
                            echo 'The Importance of Choosing the Right Furniture'; 
                        }
                    ?>
                </h1>
                <!-- Author -->
            ...
            <div class="s-py-50" data-aos="fade-up" data-aos-delay="100">
                ...
                <img class="w-full" style="max-height: 383px; object-fit-cover background-position: center;" src="<?php echo !empty($article['img']) ? $static_url . $article['img'] : $static_url . '/img/thumb/blog-details.jpg'; ?>" alt="blog-details">
