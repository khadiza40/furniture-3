...
?>
            ...
            <div class="max-w-[1720px] mx-auto">
                <div class="absolute top-5 right-[30%] z-10 hidden lg:block shape-01">
                    ...
                    <div class="absolute top-1/4 left-[10%] xl:left-[20%] z-30">
                        <h4 class="leading-none text-primary dark:text-primary font-semibold text-2xl md:text-1xl">$140</h4>
                        <h3 class="leading-none md:mt-4 text-3xl md:text-1xl font-bold">Aurora Flexible Sofa</h3>
                        <div class="group mt-[10px]">
                            <a href="product-details.php" class="text-lg leading-none text-title font-medium  text-underline dark:text-white">Buy Now</a>
                        </div>
                    </div>                  
                </div>
                ...
                <div class="flex items-center justify-between gap-8 flex-col sm:flex-row">
                    <div class="relative z-10 sm:max-w-[632px] w-full slider-content">
                        ...
                        <div class="button mt-4 md:mt-6">
                            <a class="btn btn-outline" href="shop-v1.php" data-text="Shop Now"><span>Shop Now</span></a>
                        </div>
                    </div>
                    <div class="sm:max-w-[750px] w-full">
                        <img class="slider-img" src="<?php echo $static_url; ?>/img/home-v1/banner-01.png" alt="banner-slider">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="relative pt-12 md:pt-20 xl:pt-[100px] pb-12 sm:pb-24 px-[15px] sm:px-12 bg-[#F5F5F5] dark:bg-title">
            <div class="max-w-[1720px] mx-auto">
                <div class="absolute top-5 right-[30%] z-10 hidden lg:block shape-01">
                    ...
                    <div class="absolute top-1/4 left-[10%] xl:left-[20%] z-30">
                        <h4 class="leading-none text-[#627952] dark:text-[#627952] font-semibold text-2xl md:text-1xl">$110</h4>
                        <h3 class="leading-none md:mt-4 text-3xl md:text-1xl font-bold">Aurora Flexible Vase</h3>
                        <div class="group mt-[10px]">
                            <a href="product-details.php" class="text-lg leading-none text-title font-medium  text-underline dark:text-white">Buy Now</a>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-between gap-8 flex-col sm:flex-row">
                    <div class="relative z-10 sm:max-w-[632px] w-full slider-content">
                        ...
                        <div class="button mt-4 md:mt-6">
                            <a class="btn btn-outline" href="shop-v2.php" data-text="Shop Now"><span>Shop Now</span></a>
                        </div>
                    </div>
                    <div class="sm:max-w-[750px] w-full">
                        <img class="slider-img" src="<?php echo $static_url; ?>/img/home-v1/banner-02.png" alt="banner-slider">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="max-w-xl mx-auto mb-8 md:mb-12 text-center" data-aos="fade-up">
                <div>
                    <svg class="mx-auto w-14 sm:w-24" viewBox="0 0 67 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.756 51.3601C12.1769 55.3028 11.7832 59.3357 11.7832 63H17.2854C17.2854 63 18.1191 58.2701 19.528 52.2941" stroke="#BB976D" stroke-width="2.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M54.2154 51.3601C54.7945 55.3028 55.1882 59.3357 55.1882 63H49.686C49.686 63 48.8523 58.2701 47.4434 52.2941" stroke="#BB976D" stroke-width="2.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <div class="max-w-[1720px] mx-auto relative group" data-aos="fade-up" data-aos-delay="100">
                <div class="owl-carousel hv1-pdct-ctgry-slider" data-carousel-items="3" data-carousel-xl="3" data-carousel-lg="2" data-carousel-md="2" data-carousel-sm="2" data-carousel-xs="1" data-carousel-margin="10" data-carousel-loop="true" data-carousel-autoplay="true"> 
                    ...
                    <?php
                        include "$base_dir/Components/Home/product-category.php";
                    ?>

                </div>
                
                <!-- Slider Navigation -->
                <button class="icon hv1pdct_prev w-9 h-9 md:w-14 md:h-14 flex items-center justify-center text-title duration-300 bg-white hover:bg-primary transform p-2 absolute top-1/2  -translate-y-1/2 left-0 z-[999]" aria-label="Prev Navigation">
                ...
                <button class="icon hv1pdct_next w-9 h-9 md:w-14 md:h-14 flex items-center justify-center text-title duration-300 bg-white hover:bg-primary transform p-2 absolute top-1/2 -translate-y-1/2 right-0 z-[999]" aria-label="Next Navigation">
                    <svg class="fill-current" width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="s-py-50-100">
        <div class="container-fluid">
            ...
            <div class="text-center mt-7 md:mt-12">
                <a href="shop-v1.php" class="btn btn-outline" data-text="All Products">
    ...
    <!-- Choose Area Start -->
    <div class="s-py-100 bg-overlay dark:before:bg-title dark:before:bg-opacity-80" style="background-image: url('<?php echo $static_url; ?>/img/home-v1/choose-us-bg.jpg');">
        <img class="absolute top-0 right-0 w-[20%] z-[-1]" src="<?php echo $static_url; ?>/img/home-v1/shape-01.png" alt="shape">
        <div class="container-fluid">
            <div class="max-w-[1720px] mx-auto">
    ...
    <div class="s-py-100-50">
        <div class="container-fluid">
            ...
            <div class="max-w-[1720px] mx-auto flex gap-5 sm:gap-8 flex-col lg:flex-row" data-aos="fade-up" data-aos-delay="100">
                ...
                <?php
                    include "$base_dir/Components/Home/featured-products.php";
                ?>
    ...
    <div class="s-py-50-100">
        <div class="container-fluid">
            ...
            <div data-aos="fade-up" data-aos-delay="100">
                ...
                <?php
                    include "$base_dir/Components/Home/trusted-partner.php";
                ?>
